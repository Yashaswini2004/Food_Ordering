    ...
    <div className="w-full h-[140px] p-2 shadow-lg flex justify-between">
      <div className="w-[60%] h-full flex gap-3">
        ...
        <div className="w-[40%] h-full flex flex-col gap-5">
          ...
          <div className="w-[100px] h-[50px] bg-slate-400 flex rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-green-400 text-xl">
            <button className="w-[30%] h-full bg-white flex justify-center items-center text-green-400 hover:bg-gray-200"  onClick={() => {qty>1?dispatch(DecrementQty(id)):1}}>
              -
            </button>
      ...
      <div className="flex flex-col justify-start items-end gap-6">
        ...
        <RiDeleteBin6Line
          ...
          onClick={() =>{dispatch(RemoveItem(id)); toast.error("Removed item from cart")}}
        />
      </div>
    </div>
  );
